...
#define OSM_AGR  OSM(MOD_RALT) // no longer used
#define OSL_FUN  OSL(_FUNC)
#define GUI_ENT  GUI_T(KC_ENT)
#define LOW_TAB  LT(_LOWER, KC_TAB)
#define RSE_BSP  LT(_RAISE, KC_BSPC) // swapped for RSE_SFT
#define RSE_SFT  LT(_RAISE, MOD_LSFT)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
        [_QWERTY] = LAYOUT(
            ...
            //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
            OSM_LCTL,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,                           KC_H    ,KC_J    ,KC_K    ,KC_L   ,KC_SEMICOLON, KC_QUOT ,
            //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
            OSM(MOD_LSFT),   KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                     KC_N    ,KC_M    ,KC_COMM ,KC_DOT  ,KC_SLSH ,OSL_FUN ,
            //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                                    OSM(MOD_LALT), KC_SPC, LOW_TAB,   RSE_SFT , KC_BACKSPACE  ,GUI_ENT
            //`--------------------------'  `--------------------------'
            ),
